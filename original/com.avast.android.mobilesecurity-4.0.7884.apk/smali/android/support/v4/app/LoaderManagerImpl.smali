...
.field final mInactiveLoaders:Landroid/support/v4/d/o;
...
.field final mLoaders:Landroid/support/v4/d/o;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v4/d/o",
            "<",
...
.method constructor <init>(Ljava/lang/String;Landroid/support/v4/app/FragmentActivity;Z)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/d/o;
    ...
    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Landroid/support/v4/d/o;
...
.method private createLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;
    ...
    .line 490
    invoke-interface {p3, p1, p2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onCreateLoader(ILandroid/os/Bundle;)Landroid/support/v4/a/p;

    move-result-object v1

    .line 491
    iput-object v1, v0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/a/p;
...
.method public destroyLoader(I)V
    ...
    .line 663
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/d/o;

    invoke-virtual {v0, p1}, Landroid/support/v4/d/o;->g(I)I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/d/o;->f(I)Ljava/lang/Object;
    ...
    .line 666
    iget-object v2, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/d/o;

    invoke-virtual {v2, v1}, Landroid/support/v4/d/o;->d(I)V
    ...
    .line 669
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Landroid/support/v4/d/o;
    ...
    .line 672
    iget-object v2, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Landroid/support/v4/d/o;
...
.method doDestroy()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/d/o;->b()I
    ...
    invoke-virtual {v0}, Landroid/support/v4/d/o;->c()V
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v4, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/d/o;

    invoke-virtual {v4, v1}, Landroid/support/v4/d/o;->e(I)I
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/d/o;->f(I)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Landroid/support/v4/d/o;

    invoke-virtual {v3, v2}, Landroid/support/v4/d/o;->e(I)I
...
.method public getLoader(I)Landroid/support/v4/a/p;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<D:",
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/d/o;->a(I)Ljava/lang/Object;
    ...
    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/a/p;
...
.method public initLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/a/p;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<D:",
    ...
    .line 562
    iget-object v1, v0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/a/p;

    iget-object v2, v0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mData:Ljava/lang/Object;

    invoke-virtual {v0, v1, v2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Landroid/support/v4/a/p;Ljava/lang/Object;)V
...
.method installLoader(Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;)V
    ...
    invoke-virtual {v0, v1, p1}, Landroid/support/v4/d/o;->b(ILjava/lang/Object;)V
...
.method public restartLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/a/p;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<D:",
    ...
    .line 600
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Landroid/support/v4/d/o;

    invoke-virtual {v1, p1}, Landroid/support/v4/d/o;->a(I)Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Landroid/support/v4/a/p;->r()V

    .line 611
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Landroid/support/v4/d/o;

    invoke-virtual {v1, p1, v0}, Landroid/support/v4/d/o;->b(ILjava/lang/Object;)V
    ...
    .line 620
    :cond_5
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/d/o;

    invoke-virtual {v1, p1, v4}, Landroid/support/v4/d/o;->b(ILjava/lang/Object;)V
